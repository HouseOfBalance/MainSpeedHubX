...
AddStatsLabel(Stats)
local Visual = Window:MakeTab({"Visual", "rbxassetid://15877464662"})
Silder(Visual, "Set Cash", 0, 10000000, 50000)
Toggle(Visual, "Enable Cash Fake", "", false)
Visual:AddSection("ESP")
Toggle(Visual, "ESP Player", "", false)
Window:SelectTab(2)
return SpeedHubX
